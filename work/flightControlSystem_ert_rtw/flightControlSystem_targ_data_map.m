    ...
    ;%***********************
        ...
        ;%
            ...
            section.data(31)  = dumData; %prealloc
                    ...
                    ;% dexojrsdjj.BINARIZER_THRESHOLD
                    section.data(1).logicalSrcIdx = 1;
                    section.data(1).dtTransOffset = 0;

                    ;% dexojrsdjj.CHANGE_DERIVATIVE_ERROR_THRESHOLD_X
                    section.data(2).logicalSrcIdx = 2;
                    section.data(2).dtTransOffset = 1;

                    ;% dexojrsdjj.CHANGE_DERIVATIVE_ERROR_THRESHOLD_Y
                    ...
                    ;% dexojrsdjj.DERIVATIVE_GAIN_X
                    section.data(8).logicalSrcIdx = 8;
                    section.data(8).dtTransOffset = 7;

                    ;% dexojrsdjj.DERIVATIVE_GAIN_Y
                    ...
                    ;% dexojrsdjj.MAX_RADIUS_CROWN
                    section.data(18).logicalSrcIdx = 18;
                    section.data(18).dtTransOffset = 17;

                    ;% dexojrsdjj.MAX_RADIUS_TRACK
                    section.data(19).logicalSrcIdx = 19;
                    section.data(19).dtTransOffset = 18;

                    ;% dexojrsdjj.MIN_RADIUS_CROWN
                    section.data(20).logicalSrcIdx = 20;
                    section.data(20).dtTransOffset = 19;

                    ;% dexojrsdjj.MIN_RADIUS_TRACK
                    section.data(21).logicalSrcIdx = 21;
                    section.data(21).dtTransOffset = 20;

                    ;% dexojrsdjj.TIME_HOLD_X
                    section.data(22).logicalSrcIdx = 22;
                    section.data(22).dtTransOffset = 21;

                    ;% dexojrsdjj.TIME_HOLD_Y
            ...
            section.data(8)  = dumData; %prealloc
                    ...
                    ;% dexojrsdjj.fxgka2mnesn.DiscreteDerivative_ICPrevScaledInput_hslg1vhatn
            ...
            section.data(55)  = dumData; %prealloc
                    ...
                    ;% dexojrsdjj.fxgka2mnesn.Constant_Value_kfmfwh2xv0
    ...
    ;%**************************
        ...
        ;%
            ...
            section.data(6)  = dumData; %prealloc
                    ...
                    ;% ntrh2fpvwnc.cgoj3vdp44
                    section.data(2).logicalSrcIdx = 1;
                    section.data(2).dtTransOffset = 6;

                    ;% ntrh2fpvwnc.n0gcxmjj1b
                    section.data(3).logicalSrcIdx = 5;
                    section.data(3).dtTransOffset = 7;

                    ;% ntrh2fpvwnc.bfd1leqy53
                    section.data(4).logicalSrcIdx = 9;
                    section.data(4).dtTransOffset = 8;

                    ;% ntrh2fpvwnc.bheju0v5fa
                    section.data(5).logicalSrcIdx = 10;
                    section.data(5).dtTransOffset = 9;

                    ;% ntrh2fpvwnc.gmbfc4sr44
            ...
            section.data(4)  = dumData; %prealloc
                    ...
                    ;% ntrh2fpvwnc.lwgkuchmis
                    section.data(1).logicalSrcIdx = 15;
                    section.data(1).dtTransOffset = 0;

                    ;% ntrh2fpvwnc.j3l4jxxhin
                    section.data(2).logicalSrcIdx = 16;
                    section.data(2).dtTransOffset = 19200;

                    ;% ntrh2fpvwnc.lbmt023smw
                    section.data(3).logicalSrcIdx = 17;
                    section.data(3).dtTransOffset = 38400;

                    ;% ntrh2fpvwnc.pyqrapzixu
            ...
            section.data(22)  = dumData; %prealloc
                    ...
                    ;% ntrh2fpvwnc.fxgka2mnesn.fhn5bnveg5
                    section.data(2).logicalSrcIdx = 21;
                    section.data(2).dtTransOffset = 1;

                    ;% ntrh2fpvwnc.fxgka2mnesn.peqv3cgqby
                    section.data(3).logicalSrcIdx = 22;
                    section.data(3).dtTransOffset = 2;

                    ;% ntrh2fpvwnc.fxgka2mnesn.o5mevcygfa
                    section.data(4).logicalSrcIdx = 23;
                    section.data(4).dtTransOffset = 3;

                    ;% ntrh2fpvwnc.fxgka2mnesn.j1zdbzcqct
                    ...
                    ;% ntrh2fpvwnc.fxgka2mnesn.putyqemkto
                    section.data(9).logicalSrcIdx = 29;
                    section.data(9).dtTransOffset = 12;

                    ;% ntrh2fpvwnc.fxgka2mnesn.ggzh1b0vd5
                    section.data(10).logicalSrcIdx = 30;
                    section.data(10).dtTransOffset = 13;

                    ;% ntrh2fpvwnc.fxgka2mnesn.gyvsilelfo
                    section.data(11).logicalSrcIdx = 32;
                    section.data(11).dtTransOffset = 14;

                    ;% ntrh2fpvwnc.fxgka2mnesn.cjktqoa53l
                    section.data(12).logicalSrcIdx = 33;
                    section.data(12).dtTransOffset = 15;

                    ;% ntrh2fpvwnc.fxgka2mnesn.dz1uwbr45y
                    section.data(13).logicalSrcIdx = 34;
                    section.data(13).dtTransOffset = 16;

                    ;% ntrh2fpvwnc.fxgka2mnesn.bsjxeup4hu
                    section.data(14).logicalSrcIdx = 35;
                    section.data(14).dtTransOffset = 17;

                    ;% ntrh2fpvwnc.fxgka2mnesn.ennebvxv1f
                    section.data(15).logicalSrcIdx = 36;
                    section.data(15).dtTransOffset = 18;

                    ;% ntrh2fpvwnc.fxgka2mnesn.iqy2muygmg
                    section.data(16).logicalSrcIdx = 39;
                    section.data(16).dtTransOffset = 19;

                    ;% ntrh2fpvwnc.fxgka2mnesn.ghh3gtkvgb
                    section.data(17).logicalSrcIdx = 40;
                    section.data(17).dtTransOffset = 20;

                    ;% ntrh2fpvwnc.fxgka2mnesn.bt33as5who
                    section.data(18).logicalSrcIdx = 41;
                    section.data(18).dtTransOffset = 21;

                    ;% ntrh2fpvwnc.fxgka2mnesn.gnqa1hkj5y
                    section.data(19).logicalSrcIdx = 42;
                    section.data(19).dtTransOffset = 22;

                    ;% ntrh2fpvwnc.fxgka2mnesn.de5ngwes1c
                    section.data(20).logicalSrcIdx = 45;
                    section.data(20).dtTransOffset = 23;

                    ;% ntrh2fpvwnc.fxgka2mnesn.idqisdhg1q
                    section.data(21).logicalSrcIdx = 46;
                    section.data(21).dtTransOffset = 24;

                    ;% ntrh2fpvwnc.fxgka2mnesn.lczqmi5kkf
    ...
    ;%*******************
        ...
        ;%
            ...
            section.data(13)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.ob2q0btond
                    section.data(1).logicalSrcIdx = 0;
                    section.data(1).dtTransOffset = 0;

                    ;% cjyyyt0pe2y.lvzgqatx2z
                    section.data(2).logicalSrcIdx = 1;
                    section.data(2).dtTransOffset = 1;
            ...
            section.data(9)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.hyb1x0nl2d
                    section.data(1).logicalSrcIdx = 14;
                    section.data(1).dtTransOffset = 0;

                    ;% cjyyyt0pe2y.puqpzdiuzg
                    section.data(2).logicalSrcIdx = 15;
                    section.data(2).dtTransOffset = 2;

                    ;% cjyyyt0pe2y.lrlyytp3oh
                    section.data(3).logicalSrcIdx = 16;
                    section.data(3).dtTransOffset = 4;

                    ;% cjyyyt0pe2y.euoedppr1i
                    section.data(4).logicalSrcIdx = 17;
                    section.data(4).dtTransOffset = 18;

                    ;% cjyyyt0pe2y.fqduhh5xpo
                    section.data(5).logicalSrcIdx = 18;
                    section.data(5).dtTransOffset = 24;

                    ;% cjyyyt0pe2y.h03imho3hq
                    section.data(6).logicalSrcIdx = 19;
                    section.data(6).dtTransOffset = 30;

                    ;% cjyyyt0pe2y.arxlbcmdot
                    section.data(7).logicalSrcIdx = 20;
                    section.data(7).dtTransOffset = 220;

                    ;% cjyyyt0pe2y.ikhd25pg2y
                    section.data(8).logicalSrcIdx = 21;
                    section.data(8).dtTransOffset = 221;

                    ;% cjyyyt0pe2y.mkhuav0tui
                    section.data(9).logicalSrcIdx = 22;
                    section.data(9).dtTransOffset = 222;
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.ejxjdm2xjy
                    section.data(1).logicalSrcIdx = 27;
                    section.data(1).dtTransOffset = 0;

                    ;% cjyyyt0pe2y.ozutg4jx4l
            ...
            section.data(13)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.pyvoq4isrj
                    section.data(2).logicalSrcIdx = 30;
                    section.data(2).dtTransOffset = 1;

                    ;% cjyyyt0pe2y.nzbvz2jfq0
                    section.data(3).logicalSrcIdx = 31;
                    section.data(3).dtTransOffset = 2;

                    ;% cjyyyt0pe2y.an0dusypyj
                    section.data(4).logicalSrcIdx = 32;
                    section.data(4).dtTransOffset = 3;

                    ;% cjyyyt0pe2y.efpnzc40o1
                    section.data(5).logicalSrcIdx = 33;
                    section.data(5).dtTransOffset = 4;

                    ;% cjyyyt0pe2y.koykgmhqxu
                    section.data(6).logicalSrcIdx = 34;
                    section.data(6).dtTransOffset = 5;

                    ;% cjyyyt0pe2y.kdm5zd2xfu
                    section.data(7).logicalSrcIdx = 35;
                    section.data(7).dtTransOffset = 6;

                    ;% cjyyyt0pe2y.pjgzd0tvf2
                    section.data(8).logicalSrcIdx = 36;
                    section.data(8).dtTransOffset = 7;

                    ;% cjyyyt0pe2y.apkl23kc1r
                    section.data(9).logicalSrcIdx = 37;
                    section.data(9).dtTransOffset = 8;

                    ;% cjyyyt0pe2y.fr2kjahm3c
                    section.data(10).logicalSrcIdx = 38;
                    section.data(10).dtTransOffset = 9;

                    ;% cjyyyt0pe2y.dyztf3ag1e
                    section.data(11).logicalSrcIdx = 39;
                    section.data(11).dtTransOffset = 10;

                    ;% cjyyyt0pe2y.bmnsxl4xog
                    section.data(12).logicalSrcIdx = 40;
                    section.data(12).dtTransOffset = 11;

                    ;% cjyyyt0pe2y.astpjo2bwi
            ...
            section.data(17)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.mkflkbiehv
                    section.data(4).logicalSrcIdx = 45;
                    section.data(4).dtTransOffset = 6;

                    ;% cjyyyt0pe2y.fxgka2mnesn.i4hyprti4x
                    section.data(5).logicalSrcIdx = 46;
                    section.data(5).dtTransOffset = 10;

                    ;% cjyyyt0pe2y.fxgka2mnesn.ows4wurycd
                    section.data(6).logicalSrcIdx = 47;
                    section.data(6).dtTransOffset = 11;

                    ;% cjyyyt0pe2y.fxgka2mnesn.byr4452v2l
                    section.data(7).logicalSrcIdx = 48;
                    section.data(7).dtTransOffset = 12;

                    ;% cjyyyt0pe2y.fxgka2mnesn.h1sgxj04c1
                    section.data(8).logicalSrcIdx = 49;
                    section.data(8).dtTransOffset = 13;

                    ;% cjyyyt0pe2y.fxgka2mnesn.atv1o5pyht
                    section.data(9).logicalSrcIdx = 50;
                    section.data(9).dtTransOffset = 14;

                    ;% cjyyyt0pe2y.fxgka2mnesn.lt2argo151
                    section.data(10).logicalSrcIdx = 51;
                    section.data(10).dtTransOffset = 15;

                    ;% cjyyyt0pe2y.fxgka2mnesn.cl4ml34pqs
                    section.data(11).logicalSrcIdx = 52;
                    section.data(11).dtTransOffset = 16;

                    ;% cjyyyt0pe2y.fxgka2mnesn.m4pyr5nw3g
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.gjyzjwfess
                    section.data(14).logicalSrcIdx = 56;
                    section.data(14).dtTransOffset = 19;

                    ;% cjyyyt0pe2y.fxgka2mnesn.ak3a0zckrm
                    section.data(15).logicalSrcIdx = 57;
                    section.data(15).dtTransOffset = 20;

                    ;% cjyyyt0pe2y.fxgka2mnesn.of151lhjnq
                    section.data(16).logicalSrcIdx = 58;
                    section.data(16).dtTransOffset = 21;

                    ;% cjyyyt0pe2y.fxgka2mnesn.btzrsjk5oi
            ...
            section.data(9)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.ischlzg4xj.LoggedData
                    section.data(2).logicalSrcIdx = 61;
                    section.data(2).dtTransOffset = 1;

                    ;% cjyyyt0pe2y.fxgka2mnesn.lcw1c0wg4n.LoggedData
                    section.data(3).logicalSrcIdx = 62;
                    section.data(3).dtTransOffset = 3;

                    ;% cjyyyt0pe2y.fxgka2mnesn.f1pxfznjk2.LoggedData
                    section.data(4).logicalSrcIdx = 63;
                    section.data(4).dtTransOffset = 4;

                    ;% cjyyyt0pe2y.fxgka2mnesn.n4m1cda4q5.LoggedData
                    section.data(5).logicalSrcIdx = 64;
                    section.data(5).dtTransOffset = 5;

                    ;% cjyyyt0pe2y.fxgka2mnesn.egma4kbk1o.LoggedData
                    section.data(6).logicalSrcIdx = 65;
                    section.data(6).dtTransOffset = 6;

                    ;% cjyyyt0pe2y.fxgka2mnesn.pm3ycmdwvi.LoggedData
                    section.data(7).logicalSrcIdx = 66;
                    section.data(7).dtTransOffset = 7;

                    ;% cjyyyt0pe2y.fxgka2mnesn.o24xtjnwth.LoggedData
                    section.data(8).logicalSrcIdx = 67;
                    section.data(8).dtTransOffset = 8;

                    ;% cjyyyt0pe2y.fxgka2mnesn.phy5rp2f2p.LoggedData
            ...
            section.data(15)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.fwbl2ndtt3
                    section.data(3).logicalSrcIdx = 103;
                    section.data(3).dtTransOffset = 2;

                    ;% cjyyyt0pe2y.fxgka2mnesn.ncbrxv2glf
                    section.data(4).logicalSrcIdx = 104;
                    section.data(4).dtTransOffset = 3;

                    ;% cjyyyt0pe2y.fxgka2mnesn.f2nhn302mh
                    section.data(5).logicalSrcIdx = 105;
                    section.data(5).dtTransOffset = 4;

                    ;% cjyyyt0pe2y.fxgka2mnesn.bolz4gqde0
                    section.data(6).logicalSrcIdx = 106;
                    section.data(6).dtTransOffset = 5;

                    ;% cjyyyt0pe2y.fxgka2mnesn.frgrlvrbma
                    section.data(7).logicalSrcIdx = 107;
                    section.data(7).dtTransOffset = 6;

                    ;% cjyyyt0pe2y.fxgka2mnesn.ayoniztweq
                    section.data(8).logicalSrcIdx = 108;
                    section.data(8).dtTransOffset = 7;

                    ;% cjyyyt0pe2y.fxgka2mnesn.laiq5cug32
                    section.data(9).logicalSrcIdx = 109;
                    section.data(9).dtTransOffset = 8;

                    ;% cjyyyt0pe2y.fxgka2mnesn.eejg4mqkxr
                    section.data(10).logicalSrcIdx = 110;
                    section.data(10).dtTransOffset = 9;

                    ;% cjyyyt0pe2y.fxgka2mnesn.l0h4q5nhf1
                    section.data(11).logicalSrcIdx = 111;
                    section.data(11).dtTransOffset = 10;

                    ;% cjyyyt0pe2y.fxgka2mnesn.lgapoywbyj
                    section.data(12).logicalSrcIdx = 112;
                    section.data(12).dtTransOffset = 11;

                    ;% cjyyyt0pe2y.fxgka2mnesn.hauilmpx1p
                    section.data(13).logicalSrcIdx = 113;
                    section.data(13).dtTransOffset = 12;

                    ;% cjyyyt0pe2y.fxgka2mnesn.kvp3bmiue1
            ...
            section.data(9)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.mswxbqzodr
                    section.data(1).logicalSrcIdx = 116;
                    section.data(1).dtTransOffset = 0;

                    ;% cjyyyt0pe2y.fxgka2mnesn.lpdj1malfu
                    section.data(2).logicalSrcIdx = 117;
                    section.data(2).dtTransOffset = 1;

                    ;% cjyyyt0pe2y.fxgka2mnesn.iwhrq5lft3
                    section.data(3).logicalSrcIdx = 118;
                    section.data(3).dtTransOffset = 2;

                    ;% cjyyyt0pe2y.fxgka2mnesn.dwotjlzpcd
                    section.data(4).logicalSrcIdx = 119;
                    section.data(4).dtTransOffset = 3;

                    ;% cjyyyt0pe2y.fxgka2mnesn.lzc2goeczz
                    section.data(5).logicalSrcIdx = 120;
                    section.data(5).dtTransOffset = 4;

                    ;% cjyyyt0pe2y.fxgka2mnesn.e0fwr5jde2
                    section.data(6).logicalSrcIdx = 121;
                    section.data(6).dtTransOffset = 5;

                    ;% cjyyyt0pe2y.fxgka2mnesn.cvqbrko22m
                    section.data(7).logicalSrcIdx = 122;
                    section.data(7).dtTransOffset = 6;

                    ;% cjyyyt0pe2y.fxgka2mnesn.lixlpfaigh
                    section.data(8).logicalSrcIdx = 123;
                    section.data(8).dtTransOffset = 7;

                    ;% cjyyyt0pe2y.fxgka2mnesn.l2tiukaa41
            ...
            section.data(7)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.ci4ssb1ejh
                    section.data(1).logicalSrcIdx = 133;
                    section.data(1).dtTransOffset = 0;

                    ;% cjyyyt0pe2y.fxgka2mnesn.p5afkjorgp
                    section.data(2).logicalSrcIdx = 134;
                    section.data(2).dtTransOffset = 1;

                    ;% cjyyyt0pe2y.fxgka2mnesn.hb2vkymcji
                    section.data(3).logicalSrcIdx = 135;
                    section.data(3).dtTransOffset = 2;

                    ;% cjyyyt0pe2y.fxgka2mnesn.laojoctbuq
                    section.data(4).logicalSrcIdx = 136;
                    section.data(4).dtTransOffset = 3;

                    ;% cjyyyt0pe2y.fxgka2mnesn.c00z1njcpd
                    section.data(5).logicalSrcIdx = 137;
                    section.data(5).dtTransOffset = 4;

                    ;% cjyyyt0pe2y.fxgka2mnesn.nowi4byky2
                    section.data(6).logicalSrcIdx = 138;
                    section.data(6).dtTransOffset = 5;

                    ;% cjyyyt0pe2y.fxgka2mnesn.l2azvmjyqj
            ...
            section.data(18)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.bn4l4euriq
                    section.data(7).logicalSrcIdx = 146;
                    section.data(7).dtTransOffset = 6;

                    ;% cjyyyt0pe2y.fxgka2mnesn.onga3af0cp
                    section.data(8).logicalSrcIdx = 147;
                    section.data(8).dtTransOffset = 7;

                    ;% cjyyyt0pe2y.fxgka2mnesn.l1xwwhadqd
                    section.data(9).logicalSrcIdx = 148;
                    section.data(9).dtTransOffset = 8;

                    ;% cjyyyt0pe2y.fxgka2mnesn.ouuhow0vgb
                    section.data(10).logicalSrcIdx = 149;
                    section.data(10).dtTransOffset = 9;

                    ;% cjyyyt0pe2y.fxgka2mnesn.noz1nuvieq
                    section.data(11).logicalSrcIdx = 150;
                    section.data(11).dtTransOffset = 10;

                    ;% cjyyyt0pe2y.fxgka2mnesn.bk1iab3lxs
                    section.data(12).logicalSrcIdx = 151;
                    section.data(12).dtTransOffset = 11;

                    ;% cjyyyt0pe2y.fxgka2mnesn.omxydxnzpb
    ...
    targMap.checksum0 = 1684440579;
    targMap.checksum1 = 3871371650;
    targMap.checksum2 = 2380944703;
    targMap.checksum3 = 2368969388;
